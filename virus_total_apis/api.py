...
class VtApi:
    ...
    @staticmethod
    def _calculate_wait_time(request_time):
        next_request_time = request_time.replace(second=1, microsecond=0) + timedelta(minutes=1)
        return next_request_time - datetime.now()
    ...
    def _request(self, request, wait_if_204=True, retry_times=0):
        error_count = 0
        ...
        while True:
            ...
            if status_code == 204:
                if wait_if_204:
                    wait_time = VtApi._calculate_wait_time(request_time)
                    if wait_time > 0:
                        time.sleep(wait_time.total_seconds())
                    continue
                else:
                    raise ExceededRateLimit(response.raw)
            if status_code == 403:
                raise NoPermissionError(response.raw)
            if retry_times < 0 or error_count < retry_times:
                error_count += 1
                time.sleep(0.01)
                continue
            raise ApiError(status_code, response.raw)


class PublicApi(VtApi):
    ...
    def __init__(self, api_key, proxies=None):
        VtApi.__init__(self, api_key, 'https://www.virustotal.com/vtapi/v2/', proxies=proxies)
        self.version = 2
    ...
    def scan_file(self, this_file, from_disk=True, filename=None, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/scan', 'post', files=files, params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))

        return self._return_response_and_status_code(response)
    ...
    def rescan_file(self, this_hash, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/rescan', 'post', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_file_report(self, this_hash, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/report', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def scan_url(self, this_url, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'url/scan', 'post', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_url_report(self, this_url, scan='0', timeout=None):
        ...
        try:
            request = Request(self.base_url + 'url/report', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def put_comments(self, resource, comment, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'comments/put', 'post', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_ip_report(self, this_ip, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'ip-address/report', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_domain_report(self, this_domain, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'domain/report', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
...
class PrivateApi(PublicApi):
    ...
    def get_upload_url(self, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/scan/upload_url', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
            if response.status_code == requests.codes.ok:
    ...
    def cancel_rescan_file(self, resource, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'rescan/delete', 'post', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_file_behaviour(self, this_hash, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/behaviour', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_network_traffic(self, this_hash, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/network-traffic', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def file_search(self, query, offset=None, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/search', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_file_clusters(self, this_date, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/clusters', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_file_distribution(self, before='', after='', reports='false', limit='1000', timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/distribution', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_file_feed(self, package=None, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/feed', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_file(self, this_hash, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'file/download', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_url_distribution(self, after=None, reports='true', limit=1000, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'url/distribution', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_url_feed(self, package=None, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'url/feed', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_comments(self, resource, before=None, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'comments/get', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
...
class IntelApi(VtApi):
    ...
    def __init__(self, api_key, proxies=None):
        VtApi.__init__(self, api_key, 'https://www.virustotal.com/intelligence/', proxies=proxies)
    ...
    def get_hashes_from_search(self, query, page=None, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'search/programmatic/', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
    ...
    def get_file(self, file_hash, save_file_at, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'download/', 'get', params=params, proxies=self.proxies, stream=True, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
    ...
    def get_all_file_report_pages(self, query):
        ...
        responses.append(self._return_response_and_status_code(response))
        while next_page:
    ...
    def get_intel_notifications_feed(self, page=None, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'hunting/notifications-feed/', 'get', params=params, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
    ...
    def delete_intel_notifications(self, ids, timeout=None):
        ...
        try:
            request = Request(self.base_url + 'hunting/delete-notifications/programmatic/?key=' + self.api_key, 'post', data=data, proxies=self.proxies, timeout=timeout)
            response = self._request(request)
        except requests.RequestException as e:
            return dict(error=str(e))
